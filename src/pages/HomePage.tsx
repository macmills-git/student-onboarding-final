  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="relative bg-gray-50 dark:bg-gray-900 space-y-20 pt-20 pb-0">
        ...
        {/* FEATURES SECTION */}
        <div className="px-4 md:px-[1.65rem] lg:px-8 pt-16 pb-0" ref={featuresRef}>
          <div className={`text-center mb-12 md:mb-[5.5rem] transition-all duration-300 delay-[225ms] ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-20'
            }`}>
            <h2 className="text-2xl md:text-[2.75rem] font-bold text-gray-800 dark:text-white mb-3 md:mb-[1.65rem]">
              Powerful Features
            </h2>
            <p className="text-sm md:text-[1.32rem] text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Everything you need for an effective manual registration
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-[2.2rem]">
            {features.map((feature, index) => {
              ...
              return (
                <Link
                  key={feature.title}
                  to={feature.link}
                  className={`group bg-transparent rounded-xl md:rounded-2xl p-4 md:p-[1.65rem] transition-all duration-300 border-2 border-gray-300 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-400 hover:scale-105 hover:-translate-y-2 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                    }`}
                  style={{ transitionDelay: `${index * 75}ms` }}
                >
                  <div className={`w-10 h-10 md:w-[3.85rem] md:h-[3.85rem] bg-gradient-to-br ${feature.color} rounded-xl md:rounded-2xl flex items-center justify-center mb-3 md:mb-[1.375rem] group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg`}>
                    <Icon className="w-5 h-5 md:w-[1.925rem] md:h-[1.925rem] text-white" />
                  </div>
                  <h3 className="text-base md:text-[1.375rem] font-bold text-gray-800 dark:text-white mb-2 md:mb-[0.825rem] group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                    {feature.title}
                  </h3>
                  <p className="text-xs md:text-[1.1rem] text-gray-600 dark:text-gray-400 mb-3 md:mb-[1.1rem] leading-relaxed">
                    {feature.description}
                  </p>
                  <div className="flex items-center text-blue-500 text-xs md:text-[1.1rem] font-medium group-hover:gap-2 transition-all duration-300">
        ...
        <div className="p-6 md:p-[4.4rem] py-12 md:py-[5.5rem] -mt-11" ref={whyChooseRef}>
          <div className={`text-center mb-10 md:mb-[4.4rem] transition-all duration-[600ms] delay-[300ms] ${isWhyChooseVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10'}`}>
            <h2 className="text-2xl md:text-[2.75rem] font-bold text-gray-800 dark:text-white mb-3 md:mb-[1.65rem]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-[3.3rem]">
            <div className={`text-center transition-all duration-[600ms] ${isWhyChooseVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`} style={{ transitionDelay: '600ms' }}>
              <div className="w-12 h-12 md:w-[4.4rem] md:h-[4.4rem] bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl md:rounded-2xl flex items-center justify-center mx-auto mb-4 md:mb-[1.65rem] shadow-lg">
                <CheckCircle2 className="w-6 h-6 md:w-[2.2rem] md:h-[2.2rem] text-white" />
              </div>
              <h3 className="text-base md:text-[1.375rem] font-bold text-gray-800 dark:text-white mb-2 md:mb-[1.1rem]">Easy to Use</h3>
              <p className="text-xs md:text-[1.1rem] text-gray-600 dark:text-gray-400">
                Intuitive interface designed for users of all technical levels
              </p>
            </div>
            <div className={`text-center transition-all duration-[600ms] ${isWhyChooseVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`} style={{ transitionDelay: '600ms' }}>
              <div className="w-12 h-12 md:w-[4.4rem] md:h-[4.4rem] bg-gradient-to-br from-green-500 to-emerald-500 rounded-xl md:rounded-2xl flex items-center justify-center mx-auto mb-4 md:mb-[1.65rem] shadow-lg">
                <Shield className="w-6 h-6 md:w-[2.2rem] md:h-[2.2rem] text-white" />
              </div>
              <h3 className="text-base md:text-[1.375rem] font-bold text-gray-800 dark:text-white mb-2 md:mb-[1.1rem]">Secure & Reliable</h3>
              <p className="text-xs md:text-[1.1rem] text-gray-600 dark:text-gray-400">
                Enterprise-grade security to protect your sensitive data
              </p>
            </div>
            <div className={`text-center transition-all duration-[600ms] ${isWhyChooseVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-20'}`} style={{ transitionDelay: '600ms' }}>
              <div className="w-12 h-12 md:w-[4.4rem] md:h-[4.4rem] bg-gradient-to-br from-cyan-500 to-blue-600 rounded-xl md:rounded-2xl flex items-center justify-center mx-auto mb-4 md:mb-[1.65rem] shadow-lg">
                <Zap className="w-6 h-6 md:w-[2.2rem] md:h-[2.2rem] text-white" />
              </div>
              <h3 className="text-base md:text-[1.375rem] font-bold text-gray-800 dark:text-white mb-2 md:mb-[1.1rem]">Lightning Fast</h3>
              <p className="text-xs md:text-[1.1rem] text-gray-600 dark:text-gray-400">
