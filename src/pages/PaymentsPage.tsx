...
import { useData, Payment, Student } from '../contexts/DataContext';
...
export const PaymentsPage = () => {
  ...
  const fetchPayments = async () => {
    ...
    // Payments data comes from shared context
    // setPayments([
    {
      id: '1',
        student_id: '1',
            ...
            amount: 2500.00,
              payment_method: 'momo',
                reference_id: 'PAY001',
                  operator: 'MTN',
                    recorded_by: 'mcmills',
                      payment_date: new Date(today.getTime() - 1 * 60 * 60 * 1000).toISOString(),
            ...
            amount: 1800.00,
              payment_method: 'cash',
                reference_id: 'PAY002',
                  operator: '',
                    recorded_by: 'clerk',
                      payment_date: new Date(today.getTime() - 3 * 60 * 60 * 1000).toISOString(),
            ...
            amount: 3200.00,
              payment_method: 'bank',
                reference_id: 'PAY003',
                  operator: 'GCB Bank',
                    recorded_by: 'mcmills',
                      payment_date: new Date(today.getTime() - 5 * 60 * 60 * 1000).toISOString(),
...
const handleAddPayment = async (e: FormEvent) => {
  ...
  // Frontend-only: Add payment to local state (no API call)
